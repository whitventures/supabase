  ...
  items: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'File Validation', url: '/guides/storage/uploads/file-validation' },
      ],
    },
    {
      name: 'Serving Files',
    ...
    },
    {
      ...
      url: undefined,
      items: [
        { name: 'Database Design', url: '/guides/storage/schema' },
        { name: 'Optimisations', url: '/guides/storage/schema' },
      ],
    },
  ],
}
